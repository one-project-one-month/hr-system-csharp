...
public class Result<T>
{
    ...
    public static Result<T> Error(string message = "Some Error Occured", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.Error };

...
CREATE TABLE Tbl_MenuGroup (
    MenuGroupId UNIQUEIDENTIFIER PRIMARY KEY,
...
CREATE TABLE Tbl_RoleAndMenuPermission (
    RoleAndMenuPermissionId UNIQUEIDENTIFIER PRIMARY KEY,
    RoleAndMenuPermissionCode NVARCHAR(50),
    RoleCode NVARCHAR(50),
    MenuGroupCode NVARCHAR(50),
    MenuCode NVARCHAR(50),
    CreatedAt DATETIME,
...
CREATE TABLE Tbl_Sequence (
    SequenceId UNIQUEIDENTIFIER PRIMARY KEY,
    UniqueName NVARCHAR(50),
...
CREATE TABLE Tbl_EmployeeProject (
    EmployeeProjectId UNIQUEIDENTIFIER PRIMARY KEY,
    EmployeeProjectCode NVARCHAR(50),
    ProjectCode NVARCHAR(50),
...
CREATE TABLE Tbl_CompanyRule (
    CompanyRuleId UNIQUEIDENTIFIER PRIMARY KEY,
    CompanyRuleCode NVARCHAR(50),
...
CREATE TABLE Tbl_Attendance (
    AttendanceId UNIQUEIDENTIFIER PRIMARY KEY,
    AttendanceCode NVARCHAR(50),
    EmployeeCode NVARCHAR(50),
...
CREATE TABLE Tbl_Payroll (
    PayrollId UNIQUEIDENTIFIER PRIMARY KEY,
    PayrollCode NVARCHAR(50),
    EmployeeCode NVARCHAR(50),
